                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12  col-sx-12">
                          <form action="#" method="post">
                              ...
                              <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Ngày công tác</label>
                                <div class="col-sm-4">
                                  <input type="date" class="form-control" id="ngaycongtac">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Phương tiện di chuyển</label>
                                <div class="col-sm-4">
                                  <input type="text" class="form-control" id="phuongtien" placeholder="phương tiện di chuyển">
                                </div>
                              </div>
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                   <div class="form-group">
                                        <textarea class="form-control rounded-0" id="noidung" rows="3"></textarea>
                                   </div>
                                </div>
                              </div>
                              <div class="form-group row">
